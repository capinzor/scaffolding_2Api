...
class EstudiantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudiante" do
    assert_difference('Estudiante.count') do
      post estudiantes_url, params: { estudiante: { carrera: @estudiante.carrera, codigo: @estudiante.codigo, edad: @estudiante.edad, nombre: @estudiante.nombre, sede: @estudiante.sede } }, as: :json
    end
  ...
  test "should update estudiante" do
    patch estudiante_url(@estudiante), params: { estudiante: { carrera: @estudiante.carrera, codigo: @estudiante.codigo, edad: @estudiante.edad, nombre: @estudiante.nombre, sede: @estudiante.sede } }, as: :json
    assert_response 200
  end
